...
(self["webpackChunkstart_template_multipage"] = self["webpackChunkstart_template_multipage"] || []).push([ [ 7082 ], {
    7082: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        const interfaceTranslations = {
            ...
            searchSummaryAria(count) {
                if (count === 0) return "Neboli nájdené žiadne výsledky";
                const mod10 = count % 10;
                const mod100 = count % 100;
                if (mod10 === 1 && mod100 !== 11) return `${count} výsledok nájdený`;
                const isFew = mod10 >= 2 && mod10 <= 4 && !(mod100 >= 12 && mod100 <= 14);
                if (isFew) return `${count} výsledky nájdené`;
