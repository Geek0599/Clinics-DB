(() => {
    ...
    (() => {
        ...
        function init_ProductReviewsSlider() {
            const sliderBlock = document.querySelector('[data-slider="product-reviews"]');
            if (sliderBlock) {
        ...
        function init_mainProductSlider() {
            const sliderBlock = document.querySelector('[data-slider="main-product"]');
            ...
            const enableSwiper = () => {
                ...
                swiperInstance = new swiper_core_Swiper(slider, {
                    modules: [ pagination_Pagination ],
                    slidesPerView: 1,
                    spaceBetween: 8,
                    speed: 600,
            ...
            const destroySwiper = () => {
                ...
                swiperInstance = void 0;
            };
            const breakpointChecker = () => {
                if (breakpoint.matches) destroySwiper(); else enableSwiper();
            };
            breakpointChecker();
        ...
        function init_ProductGallary() {
            ...
            const openBtn = document.querySelector("[data-gallery-btn]");
            if (!openBtn) return;
            const items = document.querySelectorAll("[data-fancybox]");
            if (!items.length) return;
            openBtn.addEventListener("click", (e => {
                Oe.show([ ...items ].map((item => ({
        ...
        function showMoreStaticElems() {
            const showMoreContainers = document.querySelectorAll("[data-show-more-items]");
        ...
        function scrollBasedNavigation() {
            const buttonSelector = "[data-goto]";
            const stickySelector = "[data-sticky-titles]";
